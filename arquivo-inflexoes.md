...
| Métrica | Valor | Base |
|---|---|---|
| Lead time inflexão→mainstream | ~6-9 meses (estimativa inicial, 2 observações retroativas: AP out/2025→1S2026; grid out/2025→1S2026) | Refinamento corrida #2: "mainstream" = perda de edge de cobertura, ≠ pico industrial (grid ainda a subir industrialmente com b2b 1,72). Corrida #3: sem nova maturação forward |
| Taxa de maturação | sem dados forward suficientes | NdFeB entrou já maduro; não conta como tema qualificado que maturou |
